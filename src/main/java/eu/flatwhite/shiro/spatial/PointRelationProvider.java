...
/**
 * "Same point" relation provider just checks is the distance between two
 * spatial zero, hence, they are (in 2d for example) same points. As points has
 * no spatial extension, they may only related as TOUCH (two points overlays) or
